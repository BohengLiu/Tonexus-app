  ...
  return (
    ...
    >
      <img
        ...
        src="/symbol.svg"
        alt="symbol"
        className="w-[213px] h-[213px] absolute right-[300px] top-[335px]"
      />
      <div
        ref={filterRef}
      ...
      <div className="text-white mt-[210px] ml-[108px] z-10">
        ...
        <p className="whitespace-pre font-light leading-[1.6] text-[32px] opacity-80 mt-[70px]">
          {`We build genuine trust through \nblockchain and math, \neliminating traditional \nbarriers and empowering free \ncommunication and \ncollaboration.`}
        </p>
      </div>
      <div className="w-[596px] mt-[70px] text-white whitespace-pre font-light leading-[1.6] text-[32px] opacity-80 self-center">
